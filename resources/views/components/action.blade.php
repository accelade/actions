...
>
    @if($variant === 'icon' && $icon)
        <span class="action-icon"><x-accelade::icon :name="$icon" :class="$iconSize" /></span>
    @else
        @if($icon && $iconPosition === 'before')
            <span class="action-icon {{ $iconBeforeClass }}"><x-accelade::icon :name="$icon" :class="$iconSize" /></span>
        @endif
        <span>{{ $label }}</span>
        @if($icon && $iconPosition === 'after')
            <span class="action-icon {{ $iconAfterClass }}"><x-accelade::icon :name="$icon" :class="$iconSize" /></span>
        @endif
    @endif
</x-accelade::link>
@endif
